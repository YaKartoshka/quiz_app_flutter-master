...
Widget submitButton(appTranslations) {
  return Container(
    ...
    child: Consumer<LoginPageProvider>(
      builder: (context, providerValue, child) {
        return buttonContent(providerValue,
            context, appTranslations); // Button Content See below..................
      },
    ),
  );
}
        ...
        onPressed: () async {
          if (providerValue.email.trim() != "" &&
            ...
            getValueFromFirebase(providerValue, context,
                profileProvider, appTranslations); // firebase Activities see below..........
          } else {
...
Future<void> getValueFromFirebase(
    providerValue, context, ProfilePageProvider profileProvider, appTranslations) async {
  ...
  try {
    ...
    short_flutter_toast(Intl.message(appTranslations['login_successful']));

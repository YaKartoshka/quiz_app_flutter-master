...
void dialogBoxResult(context, String? docID, String studName, appTranslations) {
  ...
  showDialog(
    ...
    builder: (context) {
      return AlertDialog(
        ...
        scrollable: true,
        content: content(context, facEmail, firebaseStore, Intl.message(appTranslations['student_has_not_participated'])),
      );
    },
  );
}

content(context, facEmail, Stream<QuerySnapshot<Map<String, dynamic>>> firebaseStore, alert) {
  return SizedBox(
    ...
    child: StreamBuilder(
      ...
      builder: (context, snapshot) {
        ...
        return listView(snapshot, facEmail, alert);
      },
    ),
  );
}

listView(snapshot, facEmail, alert) {

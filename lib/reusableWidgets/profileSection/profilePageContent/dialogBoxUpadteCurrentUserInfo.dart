...
dialogBoxUpdateCurrentUserInfo(context, userInfo, infoType, appTranslations) {
  showDialog(
    context: context,
    builder: (context) {
      return AlertDialog(
        ...
        actions: [buttonForSave(userInfo, infoType, appTranslations)],
...
buttonForSave(userInfo, infoType, appTranslations) {
